    ...
    <div class="row">
      <div class="col-8 offset-2">
        ...
        <div class="form-group row">
          ...
          <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('name') ?? $user->profile->title }}" required autocomplete="title" autofocus>
